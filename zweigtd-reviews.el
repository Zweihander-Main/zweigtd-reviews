...
(defun zweigtd-goals--query-interval (interval)
  "Figure out which dates user wants over INTERVAL and return calendar-read-date
format date. If nil, will return already queried value. See `zweigtd-reviews-goal-' TODO"
  (pcase interval
    ('day)
    ('week)
    ('month)
